    ...
    <table width="485" height="172" border="0"
        ...
        <tr>
            ...
            <td colspan="2" height="37" width="348">
                <input name="name2" type="text" align="left" size="38"
                       value="<%=request.getParameter("name")%>"/></td>
        </tr>
        <tr>
            <td height="39" width="121"><b><font size="4"
                                                 color="#FFFFFF" face="Comic Sans MS">Email
            </font></b> </td>
        ...
        <tr>
            <td height="39" width="121"><b><font size="4"
                                                 color="#FFFFFF" face="Comic Sans MS">Password
            </font></b> </td>
            <td colspan="2" height="39" width="348">
                <input name="password" type="text" align="left" size="38"
